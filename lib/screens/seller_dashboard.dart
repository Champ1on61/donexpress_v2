            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // 🔥 КНОПКИ УПРАВЛЕНИЯ СТАТУСОМ ДЛЯ ТЕСТА
                  if (order.status == 'new')
                    SizedBox(
                      width: double.infinity,
                      height: 40,
                  ...
                  if (order.status == 'ready_for_courier')
                    SizedBox(
                      ...
                      height: 40,
                      child: ElevatedButton(
                        onPressed: () => AppData().updateOrderStatus(order.id, 'delivering'),
                        style: ElevatedButton.styleFrom(backgroundColor: Colors.orange),
                        child: const Text('Курьер выехал'),
                      ),
                    ),
                  if (order.status == 'delivering')
                    SizedBox(
                      ...
                      height: 40,
                      child: ElevatedButton(
                        onPressed: () => AppData().updateOrderStatus(order.id, 'completed'), //  ЗАВЕРШАЕМ ЗАКАЗ
                  ...
                  if (order.status == 'completed')
                    const Text('✅ Доставлено и оценено', style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold)),
                ],
              ),
            );
          },
